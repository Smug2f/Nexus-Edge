package com.gamesense.api.util.render.shaders;
...
public class Shader {
    ...
    public Shader(final String fragmentShader) {
        ...
        try {
            ...
            final InputStream fragmentStream = this.getClass().getResourceAsStream("/assets/gamesense/shaders/fragment/" + fragmentShader);
