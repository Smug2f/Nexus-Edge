...
public class GameSenseGUI extends MinecraftHUDGUI {
    ...
    public GameSenseGUI() {
		...
		ILayout horizontalCSGOLayout=new CSGOLayout(new Labeled("gs++",null,()->true),new Point(100,100),480,WIDTH,animation,"Enabled",true,true,2,ChildMode.DOWN,colorPopup) {
			@Override
			public int getScrollHeight (Context context, int componentHeight) {
				return 320;
			}
