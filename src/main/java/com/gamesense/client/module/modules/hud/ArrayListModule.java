...
public class ArrayListModule extends HUDModule {
    ...
    public void onRender() {
        ...
        list.activeModules.sort(Comparator.comparing(module -> -GameSenseGUI.guiInterface.getFontWidth(GameSenseGUI.FONT_HEIGHT, module.getName() + ChatFormatting.GRAY + " " + module.getHudInfo())));
    }
