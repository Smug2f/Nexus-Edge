...
public class Scaffold extends Module {
    ...
    private final Listener<PlayerMoveEvent> moveEventListener = new Listener<>(event -> { // BEFORE PACKET SENT
        ...
        if (logic.getValue().equalsIgnoreCase("Predict")) {
            ...
            PredictUtil.PredictSettings predset = new PredictUtil.PredictSettings(distance.getValue(), false, 0, 0, 0, 0, 0, 0, false, 0, false, false, false, false, false, 0, 696969);
