...
public class PistonCrystal extends Module {
    ...
    IntegerSetting minHealth = registerInteger("Min Health", 8, 0, 20, () -> targetSection.getValue());
    DoubleSetting enemyRange = registerDouble("Range", 4.9, 0, 6, () -> targetSection.getValue());
    BooleanSetting placeBreakSection = registerBoolean("Place Break Section", true);
    ModeSetting breakType = registerMode("Type", Arrays.asList("Swing", "Packet"), "Swing", () -> placeBreakSection.getValue());
    ModeSetting placeMode = registerMode("Place", Arrays.asList("Torch", "Block", "Both"), "Torch", () -> placeBreakSection.getValue());
    DoubleSetting crystalDeltaBreak = registerDouble("Center Break", 0.1, 0, 0.5, () -> placeBreakSection.getValue());
    IntegerSetting crystalPlaceTry = registerInteger("Crystal Place Try", 15, 2, 30, () -> placeBreakSection.getValue());
    IntegerSetting blocksPerTick = registerInteger("Blocks Per Tick", 4, 0, 20, () -> placeBreakSection.getValue());
    IntegerSetting maxYincr = registerInteger("Max Y", 3, 0, 5, () -> placeBreakSection.getValue());
    BooleanSetting blockPlayer = registerBoolean("Trap Player", true, () -> placeBreakSection.getValue());
    BooleanSetting confirmBreak = registerBoolean("No Glitch Break", true, () -> placeBreakSection.getValue());
    BooleanSetting confirmPlace = registerBoolean("No Glitch Place", true, () -> placeBreakSection.getValue());
    BooleanSetting delaySection = registerBoolean("Delay Section", true);
    IntegerSetting supBlocksDelay = registerInteger("Surround Delay", 4, 0, 20, () -> delaySection.getValue());
    IntegerSetting startDelay = registerInteger("Start Delay", 4, 0, 20, () -> delaySection.getValue());
    IntegerSetting pistonDelay = registerInteger("Piston Delay", 2, 0, 20, () -> delaySection.getValue());
    IntegerSetting crystalDelay = registerInteger("Crystal Delay", 2, 0, 20, () -> delaySection.getValue());
    IntegerSetting redstoneDelay = registerInteger("Redstone Delay", 0, 0, 20, () -> delaySection.getValue());
    IntegerSetting midHitDelay = registerInteger("Mid Hit Delay", 5, 0, 20, () -> delaySection.getValue());
    IntegerSetting hitDelay = registerInteger("Hit Delay", 2, 0, 20, () -> delaySection.getValue());
    IntegerSetting stuckDetector = registerInteger("Stuck Check", 35, 0, 200, () -> delaySection.getValue());
    BooleanSetting rotationSection = registerBoolean("Rotation Section", true);
    BooleanSetting packetReducer = registerBoolean("Packet Reducer", false, () -> rotationSection.getValue());
    BooleanSetting rotate = registerBoolean("Rotate", false, () -> rotationSection.getValue());
    BooleanSetting preRotation = registerBoolean("Pre Rotation", false, () -> rotationSection.getValue());
    BooleanSetting forceRotation = registerBoolean("Force Rotation", false, () -> rotationSection.getValue());
    IntegerSetting preRotationDelay = registerInteger("Pre Rotation Delay", 0, 0, 20, () -> rotationSection.getValue());
    IntegerSetting afterRotationDelay = registerInteger("After Rotation Delay", 0, 0, 20, () -> rotationSection.getValue());
    BooleanSetting miscSection = registerBoolean("Misc Section", true);
    BooleanSetting allowCheapMode = registerBoolean("Cheap Mode", false, () -> miscSection.getValue());
    BooleanSetting betterPlacement = registerBoolean("Better Place", true, () -> miscSection.getValue());
    BooleanSetting bypassObsidian = registerBoolean("Bypass Obsidian", false, () -> miscSection.getValue());
    BooleanSetting antiWeakness = registerBoolean("Anti Weakness", false, () -> miscSection.getValue());
    BooleanSetting debugMode = registerBoolean("Debug Mode", false, () -> miscSection.getValue());
    BooleanSetting speedMeter = registerBoolean("Speed Meter", false, () -> miscSection.getValue());
    BooleanSetting chatMsg = registerBoolean("Chat Msgs", true, () -> miscSection.getValue());
