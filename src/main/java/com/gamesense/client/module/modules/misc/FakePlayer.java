...
public class FakePlayer extends Module {
    ...
    BooleanSetting playerStacked = registerBoolean("Player Stacked", true, () -> !copyInventory.getValue());
    BooleanSetting onShift = registerBoolean("On Shift", false);
    BooleanSetting simulateDamage = registerBoolean("Simulate Damage", true);
    StringSetting nameFakePlayer = registerString("Name FakePlayer", "Voiders");
