                ...
                switch (bNVerticesOutlineBot.getValue()) {
                    ...
                    case "2":
                        if (bdirection2OutLineBot.getValue().equals("X")) {
                            if (desyncColor.getValue()) {
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + 0), bfirstVerticeOutlineBot.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + (long) desyncColorValue.getValue()), bfirstVerticeOutlineBot.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + 0), bfirstVerticeOutlineBot.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + (long) desyncColorValue.getValue()), bfirstVerticeOutlineBot.getColor().getAlpha()));
                            } else {
                                colors.add(bfirstVerticeOutlineBot.getValue());
                    ...
                    case "4":
                        if (desyncColor.getValue()) {
                            ...
                            colors.add(new GSColor(ColorSetting.getRainbowColor(count + desyncColorValue.getValue()* 3L), bfirstVerticeOutlineBot.getColor().getAlpha()));
                        } else {
                            colors.add(bfirstVerticeOutlineBot.getValue());
                            colors.add(bsecondVerticeOutlineBot.getValue());
                ...
                switch (bNVerticesOutlineTop.getValue()) {
                    ...
                    case "2":
                        if (bdirection2OutLineTop.getValue().equals("X")) {
                            if (desyncColor.getValue()) {
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + 0), bfirstVerticeOutlineTop.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + (long) desyncColorValue.getValue()), bfirstVerticeOutlineTop.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + 0), bfirstVerticeOutlineTop.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + (long) desyncColorValue.getValue()), bfirstVerticeOutlineTop.getColor().getAlpha()));
                            } else {
                                colors.add(bfirstVerticeOutlineTop.getValue());
                    ...
                    case "4":
                        if (desyncColor.getValue()) {
                            ...
                            colors.add(new GSColor(ColorSetting.getRainbowColor(count + desyncColorValue.getValue()* 3L), bfirstVerticeOutlineTop.getColor().getAlpha()));
                        } else {
                            colors.add(bfirstVerticeOutlineTop.getValue());
                            colors.add(bsecondVerticeOutlineTop.getValue());
                ...
                switch (oNVerticesOutlineBot.getValue()) {
                    ...
                    case "2":
                        if (odirection2OutLineBot.getValue().equals("X")) {
                            if (desyncColor.getValue()) {
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + 0), ofirstVerticeOutlineBot.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + (long) desyncColorValue.getValue()), osecondVerticeOutlineBot.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + 0), ofirstVerticeOutlineBot.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + (long) desyncColorValue.getValue()), osecondVerticeOutlineBot.getColor().getAlpha()));
                            } else {
                                colors.add(ofirstVerticeOutlineBot.getValue());
                    ...
                    case "4":
                        if (desyncColor.getValue()) {
                            ...
                            colors.add(new GSColor(ColorSetting.getRainbowColor(count + desyncColorValue.getValue()* 3L), ofourVerticeOutlineBot.getColor().getAlpha()));
                        } else {
                            colors.add(ofirstVerticeOutlineBot.getValue());
                            colors.add(osecondVerticeOutlineBot.getValue());
                ...
                switch (oNVerticesOutlineTop.getValue()) {
                    ...
                    case "2":
                        if (odirection2OutLineTop.getValue().equals("X")) {
                            if (desyncColor.getValue()) {
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + 0), ofirstVerticeOutlineTop.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + (long) desyncColorValue.getValue()), osecondVerticeOutlineTop.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + 0), osecondVerticeOutlineTop.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + (long) desyncColorValue.getValue()), osecondVerticeOutlineTop.getColor().getAlpha()));
                            } else {
                                colors.add(ofirstVerticeOutlineTop.getValue());
                    ...
                    case "4":
                        if (desyncColor.getValue()) {
                            ...
                            colors.add(new GSColor(ColorSetting.getRainbowColor(count + desyncColorValue.getValue()* 3L), ofourVerticeOutlineTop.getColor().getAlpha()));
                        } else {
                            colors.add(ofirstVerticeOutlineTop.getValue());
                            colors.add(osecondVerticeOutlineTop.getValue());
                ...
                switch (NVerticesOutlineBot.getValue()) {
                    ...
                    case "2":
                        if (direction2OutLineBot.getValue().equals("X")) {
                            if (desyncColor.getValue()) {
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + 0), firstVerticeOutlineBot.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + (long) desyncColorValue.getValue()), secondVerticeOutlineBot.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + 0), firstVerticeOutlineBot.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + (long) desyncColorValue.getValue()), secondVerticeOutlineBot.getColor().getAlpha()));
                            } else {
                                colors.add(firstVerticeOutlineBot.getValue());
                    ...
                    case "4":
                        if (desyncColor.getValue()) {
                            ...
                            colors.add(new GSColor(ColorSetting.getRainbowColor(count + desyncColorValue.getValue()* 3L), fourVerticeOutlineBot.getColor().getAlpha()));
                        } else {
                            colors.add(firstVerticeOutlineBot.getValue());
                            colors.add(secondVerticeOutlineBot.getValue());
                ...
                switch (NVerticesOutlineTop.getValue()) {
                    ...
                    case "2":
                        if (direction2OutLineTop.getValue().equals("X")) {
                            if (desyncColor.getValue()) {
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + 0), firstVerticeOutlineTop.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + (long) desyncColorValue.getValue()), secondVerticeOutlineTop.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + 0), firstVerticeOutlineTop.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + (long) desyncColorValue.getValue()), secondVerticeOutlineTop.getColor().getAlpha()));
                            } else {
                                colors.add(firstVerticeOutlineTop.getValue());
                    ...
                    case "4":
                        if (desyncColor.getValue()) {
                            ...
                            colors.add(new GSColor(ColorSetting.getRainbowColor(count + desyncColorValue.getValue()* 3L), fourVerticeOutlineTop.getColor().getAlpha()));
                        } else {
                            colors.add(firstVerticeOutlineTop.getValue());
                            colors.add(secondVerticeOutlineTop.getValue());
                ...
                switch (bNVerticesFillTop.getValue()) {
                    ...
                    case "2":
                        if (bdirection2FillTop.getValue().equals("X")) {
                            if (desyncColor.getValue()) {
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + 0), bfirstVerticeFillTop.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + (long) desyncColorValue.getValue()), bsecondVerticeFillTop.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + 0), bfirstVerticeFillTop.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + (long) desyncColorValue.getValue()), bsecondVerticeFillTop.getColor().getAlpha()));
                            } else {
                                colors.add(bfirstVerticeFillTop.getValue());
                    ...
                    case "4":
                        if (desyncColor.getValue()) {
                            ...
                            colors.add(new GSColor(ColorSetting.getRainbowColor(count + desyncColorValue.getValue()* 3L), bfourVerticeFillTop.getColor().getAlpha()));
                        } else {
                            colors.add(bfirstVerticeFillTop.getValue());
                            colors.add(bsecondVerticeFillTop.getValue());
                ...
                switch (oNVerticesFillBot.getValue()) {
                    ...
                    case "2":
                        if (odirection2FillBot.getValue().equals("X")) {
                            if (desyncColor.getValue()) {
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + 0), ofirstVerticeFillBot.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + (long) desyncColorValue.getValue()), osecondVerticeFillBot.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + 0), ofirstVerticeFillBot.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + (long) desyncColorValue.getValue()), osecondVerticeFillBot.getColor().getAlpha()));
                            } else {
                                colors.add(ofirstVerticeFillBot.getValue());
                    ...
                    case "4":
                        if (desyncColor.getValue()) {
                            ...
                            colors.add(new GSColor(ColorSetting.getRainbowColor(count + desyncColorValue.getValue()* 3L), ofourVerticeFillBot.getColor().getAlpha()));
                        } else {
                            colors.add(ofirstVerticeFillBot.getValue());
                            colors.add(osecondVerticeFillBot.getValue());
                ...
                switch (oNVerticesFillTop.getValue()) {
                    ...
                    case "2":
                        if (odirection2FillTop.getValue().equals("X")) {
                            if (desyncColor.getValue()) {
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + 0), ofirstVerticeFillTop.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + (long) desyncColorValue.getValue()), osecondVerticeFillTop.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + 0), ofirstVerticeFillTop.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + (long) desyncColorValue.getValue()), osecondVerticeFillTop.getColor().getAlpha()));
                            } else {
                                colors.add(ofirstVerticeFillTop.getValue());
                    ...
                    case "4":
                        if (desyncColor.getValue()) {
                            ...
                            colors.add(new GSColor(ColorSetting.getRainbowColor(count + desyncColorValue.getValue()* 3L), ofourVerticeFillTop.getColor().getAlpha()));
                        } else {
                            colors.add(ofirstVerticeFillTop.getValue());
                            colors.add(osecondVerticeFillTop.getValue());
                ...
                switch (NVerticesFillBot.getValue()) {
                    ...
                    case "2":
                        if (direction2FillBot.getValue().equals("X")) {
                            if (desyncColor.getValue()) {
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + 0), firstVerticeFillBot.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + (long) desyncColorValue.getValue()), secondVerticeFillBot.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + 0), firstVerticeFillBot.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + (long) desyncColorValue.getValue()), secondVerticeFillBot.getColor().getAlpha()));
                            } else {
                                colors.add(firstVerticeFillBot.getValue());
                    ...
                    case "4":
                        if (desyncColor.getValue()) {
                            ...
                            colors.add(new GSColor(ColorSetting.getRainbowColor(count + desyncColorValue.getValue()* 3L), fourVerticeFillBot.getColor().getAlpha()));
                        } else {
                            colors.add(firstVerticeFillBot.getValue());
                            colors.add(secondVerticeFillBot.getValue());
                ...
                switch (NVerticesFillTop.getValue()) {
                    ...
                    case "2":
                        if (direction2FillTop.getValue().equals("X")) {
                            if (desyncColor.getValue()) {
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + 0), firstVerticeFillTop.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + (long) desyncColorValue.getValue()), secondVerticeFillTop.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + 0), firstVerticeFillTop.getColor().getAlpha()));
                                colors.add(new GSColor(ColorSetting.getRainbowColor(count + (long) desyncColorValue.getValue()), secondVerticeFillTop.getColor().getAlpha()));
                            } else {
                                colors.add(firstVerticeFillTop.getValue());
                    ...
                    case "4":
                        if (desyncColor.getValue()) {
                            ...
                            colors.add(new GSColor(ColorSetting.getRainbowColor(count + desyncColorValue.getValue()* 3L), fourVerticeFillTop.getColor().getAlpha()));
                        } else {
                            colors.add(firstVerticeFillTop.getValue());
                            colors.add(secondVerticeFillTop.getValue());
